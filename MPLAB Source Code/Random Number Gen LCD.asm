...
_0x3:
	...
	.DB  0x0,0x1,0x0,0x6
_0x0:
	.DB  0x20,0x52,0x61,0x6E,0x64,0x6F,0x6D,0x20
	.DB  0x4E,0x75,0x6D,0x62,0x65,0x72,0x73,0x0
...
;	TableSetup -> Y+1
;	i -> R16
; 0000 0010     SBI __lcd_port-1,__lcd_EN
...
_main:
; .FSTART _main
; 0000 0019     CLKPR=0x80;
	LDI  R30,LOW(128)
	STS  97,R30
; 0000 001A     CLKPR=0x04;
	LDI  R30,LOW(4)
	STS  97,R30
; 0000 001B     SetupLCD();
	RCALL _SetupLCD
; 0000 001C     StringLCD(" Random Numbers");
	__POINTW2FN _0x0,0
	RCALL _StringLCD
; 0000 001D     PORTC.0=1;  // Pull Up for Push in PB0
	SBI  0x8,0
; 0000 001E     DDRC.1=1;  // Output for Buzzer
	SBI  0x7,1
; 0000 001F     TCCR0B=0x01; // Start timer in CK (1)
	LDI  R30,LOW(1)
	OUT  0x25,R30
; 0000 0020 
; 0000 0021     while (1)
...
; 0000 0022     {
; 0000 0023 
; 0000 0024         if (PINC.0==0)
	SBIC 0x6,0
	RJMP _0x29
; 0000 0025         {
; 0000 0026             srand(TCNT0);
	IN   R30,0x26
	LDI  R31,0
	MOVW R26,R30
	RCALL _srand
; 0000 0027             num=rand()%1000;
	RCALL _rand
	MOVW R26,R30
	LDI  R30,LOW(1000)
	LDI  R31,HIGH(1000)
	RCALL __MODW21
	STS  _num,R30
; 0000 0028             sprintf(Cadena,"%003i",num);
	LDI  R30,LOW(_Cadena)
	...
	RCALL _sprintf
	ADIW R28,8
; 0000 0029             MoveCursor(6,1);
	LDI  R30,LOW(6)
	ST   -Y,R30
	LDI  R26,LOW(1)
	RCALL _MoveCursor
; 0000 002A             StringLCDVar(Cadena);
	LDI  R26,LOW(_Cadena)
	LDI  R27,HIGH(_Cadena)
	RCALL _StringLCDVar
; 0000 002B             //Sound at 0.2 seg at 400 Hz
; 0000 002C             for (i=0; i<80; i++)
	LDI  R30,LOW(0)
	STS  _i,R30
_0x2B:
	LDS  R26,_i
...
; 0000 002E                 PORTC.1=1;
	SBI  0x8,1
; 0000 002F                 delay_us(1250);
	RCALL SUBOPT_0x3
; 0000 0030                 PORTC.1=0;
	CBI  0x8,1
; 0000 0031                 delay_us(1250);
	RCALL SUBOPT_0x3
; 0000 0032             }
	LDS  R30,_i
	SUBI R30,-LOW(1)
