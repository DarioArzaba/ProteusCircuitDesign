...
; 0000 000D     DDRC=0x00;
	LDI  R30,LOW(0)
	OUT  0x7,R30
; 0000 000E     PORTC=0x0F;
	LDI  R30,LOW(15)
	OUT  0x8,R30
; 0000 000F     while (1)
_0x4:
; 0000 0010         {
; 0000 0011             PORTD=display[timerValue];
	LDS  R30,_timerValue
	LDI  R31,0
	...
	LD   R30,Z
	OUT  0xB,R30
; 0000 0012             if (PINC.0 == 0)
	SBIC 0x6,0
	RJMP _0x7
; 0000 0013             {
; 0000 0014                 timerValue++; // Add 1 to the Value if the Switch at PC0 is Pressed
	LDS  R30,_timerValue
	SUBI R30,-LOW(1)
	STS  _timerValue,R30
; 0000 0015             }
; 0000 0016             if (timerValue == 10)
_0x7:
	LDS  R26,_timerValue
	CPI  R26,LOW(0xA)
	BRNE _0x8
; 0000 0017             {
; 0000 0018                 timerValue = 0; // Restart the index to 0 if it reaches a value of 10
	LDI  R30,LOW(0)
	STS  _timerValue,R30
; 0000 0019             }
