...
_0x3:
	...
	.DB  0x0,0x1,0x0,0x6
_0x22:
	.DB  0xA,0xA,0xA,0x0,0x11,0xE
_0x23:
	.DB  0x0,0x15,0xE,0x1F,0xE,0x15
_0x24:
	.DB  0x2,0x4,0xE,0x1,0xF,0x11,0xF
_0x0:
	.DB  0x43,0x6C,0x61,0x73,0x65,0x20,0x64,0x65
	.DB  0x20,0x4D,0x69,0x63,0x72,0x6F,0x73,0x0
	.DB  0x49,0x6E,0x76,0x69,0x65,0x72,0x6E,0x6F
	.DB  0x20,0x32,0x30,0x32,0x33,0x0,0x49,0x6E
	.DB  0x69,0x63,0x69,0x61,0x72,0x0,0x20,0x6C
	.DB  0x61,0x0,0x70,0x61,0x72,0x74,0x65,0x20
	.DB  0x70,0x72,0x0,0x63,0x74,0x69,0x63,0x61
	.DB  0x0
...
; 0000 0015     SetupLCD();
	RCALL _SetupLCD
; 0000 0016     CreateChar(0,car0);
	LDI  R30,LOW(0)
	ST   -Y,R30
	LDI  R26,LOW(_car0)
	LDI  R27,HIGH(_car0)
	RCALL _CreateChar
; 0000 0017     CreateChar(1,car1);
	LDI  R30,LOW(1)
	ST   -Y,R30
	LDI  R26,LOW(_car1)
	LDI  R27,HIGH(_car1)
	RCALL _CreateChar
; 0000 0018     CreateChar(2,car2);
	LDI  R30,LOW(2)
	ST   -Y,R30
	LDI  R26,LOW(_car2)
	LDI  R27,HIGH(_car2)
...
_0x25:
; 0000 001B     {
; 0000 001C         MoveCursor(0,0);
	LDI  R30,LOW(0)
	ST   -Y,R30
	LDI  R26,LOW(0)
	RCALL _MoveCursor
; 0000 001D         StringLCD("Clase de Micros");
	__POINTW2FN _0x0,0
	RCALL _StringLCD
; 0000 001E         MoveCursor(1,1);
	LDI  R30,LOW(1)
	ST   -Y,R30
	LDI  R26,LOW(1)
	RCALL _MoveCursor
; 0000 001F         StringLCD("Invierno 2023");
	__POINTW2FN _0x0,16
	RCALL _StringLCD
; 0000 0020 
; 0000 0021         delay_ms(2000);
	RCALL SUBOPT_0x2
; 0000 0022         EraseLCD();
; 0000 0023 
; 0000 0024         MoveCursor(2,0);
	LDI  R30,LOW(2)
	ST   -Y,R30
	LDI  R26,LOW(0)
	RCALL _MoveCursor
; 0000 0025         StringLCD("Iniciar");
	__POINTW2FN _0x0,30
	RCALL _StringLCD
; 0000 0026         CharLCD(2);
	LDI  R26,LOW(2)
	RCALL _CharLCD
; 0000 0027         StringLCD(" la");
	__POINTW2FN _0x0,38
	RCALL _StringLCD
; 0000 0028         MoveCursor(0,1);
	LDI  R30,LOW(0)
	ST   -Y,R30
	LDI  R26,LOW(1)
	RCALL _MoveCursor
; 0000 0029         StringLCD("parte pr");
	__POINTW2FN _0x0,42
	RCALL _StringLCD
; 0000 002A         CharLCD(2);
	LDI  R26,LOW(2)
	RCALL _CharLCD
; 0000 002B         StringLCD("ctica");
	__POINTW2FN _0x0,51
	RCALL _StringLCD
; 0000 002C 
; 0000 002D         CharLCD(0);
